            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        ...
                        <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">{{ $data['pelanggan'] }}</div>
                    </div>
                    <div class="col-auto">
    ...
    <div class="col-xl-12 col-lg-10">
        <div class="card mb-4">
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                <h6 class="m-0 font-weight-bold text-primary">Monthly Recap Report {{ date('Y') }} </h6>
            </div>
            <div class="card-body">
...
var myLineChart = new Chart(ctx, {
  ...
  data: {
    ...
    datasets: [{
      ...
      pointHitRadius: 10,
      pointBorderWidth: 2,
      data: {!! json_encode(\Helper::chartPenjualan()) !!},
    }],
  },
  options: {
