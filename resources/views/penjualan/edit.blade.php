                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="nomor_penjualan" class="form-control" id="nomor_penjualan" placeholder="Nomor Pelanggan" value="{{ $penjualan->nomor_penjualan }}" readonly required>
                        </div>
    
                        <div class="form-group">
                            <label for="tgl_penjualan"> Tgl Penjualan</label> <i class="text-danger">*</i>
                            <input type="text" name="tgl_penjualan" class="form-control date" id="tgl_penjualan" value="{{ old('tgl_penjualan', $penjualan->tgl_penjualan) }}" required>
                        </div>
    
                        <div class="form-group">
                            <label for="pelanggan_id">Pilih Pelanggan</label> <i class="text-danger">*</i>
                            <select name="pelanggan_id" class="form-control select2" required>
                                <option value="">Pilih Pelanggan</option>
                                @foreach ($pelanggans as $pelanggan)
                                <option value="{{ $pelanggan->id }}" @if($pelanggan->id == old('pelanggan_id', $penjualan->pelanggan_id) ) selected @endif>{{ $pelanggan->nama_pelanggan }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-12" id="dynamic-field">
                        @foreach ($penjualan->barangRm as $key => $barangRm)
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <select name="barang_id[]" class="form-control select2 barang" required>
                                        ...
                                        <option value="{{ $barang->id }}" data-harga={{ $barang->harga }} @if( $barang->id == $barangRm->barang_id ) selected @endif >{{ $barang->nama_barang }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-2">
                                <div class="form-group">
                                    <input type="number" name="harga[]" class="form-control harga" id="harga" value={{ $barangRm->harga }} required>
                                </div>
                            </div>
                            
                            <div class="col-lg-2">
                                <div class="form-group">
                                    <input type="text" name="jumlah[]" class="form-control jumlah" id="jumlah" required value="{{ $barangRm->jumlah }}">
                                </div>
                            </div>
                ...
                <div class="row mt-5">
                    <div class="col-md-4">
                        ...
                        <div class="form-group">
                            <input type="number" name="diskon" class="form-control diskon" id="diskon" value="{{ $penjualan->diskon }}" required>
                        </div>
                    </div>
                </div>
